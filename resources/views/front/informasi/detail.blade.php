        ...
        <div class="row row-bottom-padded-md">
           <div class="col-lg-4 col-md-4">
                <div class="fh5co-blog animate-box">
                    <div class="blog-text">
                        <h3><a href=""#>{{ $rows->judulinformasi }}</a></h3>
                        <span class="posted_on">{{ date('d F Y', strtotime($rows->dateaddinformasi)) }}</span>
                        <span class="comment"><a href="">by : {{ $rows->namaadmin }}</a></span>
                        <p>{{ substr(strip_tags($rows->isiinformasi), 0, 100) }} ..</p>
